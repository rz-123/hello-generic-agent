...
GA 默认只能读写文件和执行代码。要让它操作浏览器，我们需要安装 **tmwd_cdp_bridge**——一个基于 CDP（Chrome DevTools Protocol，Chrome 官方开放的浏览器调试通道）的浏览器扩展。
...
<details>
<summary><strong>Q1: GA 是否自带浏览器？必须额外安装吗？</strong></summary>
...
<details>
<summary><strong>Q2: 篡改猴插件要不要装？</strong></summary>
...
<details>
<summary><strong>Q3: 安装插件时报错怎么办？</strong></summary>
...
<details>
<summary><strong>Q4: GA 能否操作需要登录的网站？</strong></summary>
...
<details>
<summary><strong>Q5: GA 能否自动登录网站？</strong></summary>
...
<details>
<summary><strong>Q6: 能否让 GA 绕过滑块验证码？</strong></summary>
